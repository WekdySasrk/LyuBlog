...
import com.Lyu.LyuBlog.service.*;
import com.Lyu.LyuBlog.util.*;
...
public class CommentUtils {
     ...
     */
    public void judgeSendNotify(Comment comment, boolean isVisitorComment, com.Lyu.LyuBlog.entity.Comment parentComment) {
     ...
     * @param comment       当前收到的评论
     */
    private void sendMailToParentComment(com.Lyu.LyuBlog.entity.Comment parentComment, com.Lyu.LyuBlog.model.dto.Comment comment) {
     ...
     * @param comment 当前收到的评论
     */
    private void notifyMyself(com.Lyu.LyuBlog.model.dto.Comment comment) {
     ...
     */
    public static CommentPageEnum getCommentPageEnum(com.Lyu.LyuBlog.model.dto.Comment comment) {
