...
public class BlogAdminController {
    ...
    @PostMapping("/blog")
    public Result saveBlog(@RequestBody com.Lyu.LyuBlog.model.dto.Blog blog) {
    ...
    @PutMapping("/blog")
    public Result updateBlog(@RequestBody com.Lyu.LyuBlog.model.dto.Blog blog) {
     ...
     * @return
     */
    private Result getResult(com.Lyu.LyuBlog.model.dto.Blog blog, String type) {
        //验证普通字段
